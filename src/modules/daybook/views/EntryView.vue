  ...
  methods: {
    ...
    async saveEntry() {
      ...
      if (this.entry.id) {
        ...
        const idEntryCreated = await this.createEntry(this.entry);
        this.$router.push({ name: "entry", params: { id: idEntryCreated } });
      }
      this.localImage = null;
      this.file = null;
    ...
    deleteEntryActual() {
      Swal.fire({
        title: "¿Estás seguro?",
        text: "Una vez borrada la entrada, no se puede recuperar",
        showDenyButton: true,
